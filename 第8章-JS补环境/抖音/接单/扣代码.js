...
url = 'device_platform=webapp&aid=6383&channel=channel_pc_web&action=heartbeat&new_user_login=0&pc_client_type=1&version_code=170400&version_name=17.4.0&cookie_enabled=true&screen_width=1440&screen_height=900&browser_language=zh-CN&browser_platform=Win32&browser_name=Edge&browser_version=120.0.0.0&browser_online=true&engine_name=Blink&engine_version=120.0.0.0&os_name=Windows&os_version=10&cpu_core_num=16&device_memory=8&platform=PC&downlink=10&effective_type=4g&round_trip_time=100&webid=7322021701401708041&msToken=MmrwOPItMMBAC0fW3aRQvRMBAzDdZ6tYV_okFSNpu9tZrVja_J9y-NQPxMwWaQpGymhu0HYFAaxJ3FgFCQLM6v75cNM_DCF19f1kAykA8YpznH6MB9t_h8UAY4_z_mI='


// 搞一个函数供外部调用
function fn(url) {
    return window.get_nn(url, undefined);
}
